...
app.get('/health', (req, res) => {
    res.json({ 
        ...
        service: 'OnTimeCar Dual Scraper v3.1 (100 filas)',
        endpoints: {
...
app.get('/consulta/agendamiento', async (req, res) => {
    ...
    try {
        ...
        console.log('Paso 8: Configurando tabla a 100 filas...');
        await page.evaluate(() => {
        ...
        console.log(`Paso 9: Buscando: ${numeroAutorizacion}`);
...
app.get('/consulta/autorizacion', async (req, res) => {
    ...
    try {
        ...
        console.log('Paso 7: Configurando grid a 100 filas...');
        await page.evaluate(() => {
            try {
                const grid = $('#grdAutorizaciones').data('kendoGrid');
                if (grid) {
                ...
                console.log('Error configurando pageSize:', e);
            }
        });
        
        await page.waitForTimeout(3000);
        
        console.log(`Paso 8: Buscando en el filtro: ${numeroAutorizacion}`);
        ...
        console.log('Paso 9: Extrayendo datos...');
...
app.listen(PORT, () => {
    console.log(`
╔══════════════════════════════════════════════════════════════════╗
║          OnTimeCar Dual Scraper v3.1 - ACTIVO                    ║
║                    (Configurado para 100 filas)                  ║
╠══════════════════════════════════════════════════════════════════╣
║  Puerto: ${PORT}                                                  ║
╠══════════════════════════════════════════════════════════════════╣
